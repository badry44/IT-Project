...
<div id="bodyWrap">
	...
	<div class="pageWrapper" id="main">
		...
		<div class="subBarOuter">
			<div class="subBarInner">
				<div class="right">
					...
					<a href="images/1.JPG" class="product">
						<img alt="New Product Image" src="" />
				...
				<div class="content">
					<div class="wide3">
						...
						<a href="#" class="product">
							<img alt="New Product Image" src="products/2.jpg" />
							<span>&pound;29.99</span>
						</a>
					</div>
					<div class="wide3">
						...
						<a href="#" class="product">
							<img alt="New Product Image" src="products/3.jpg" />
							<span>&pound;29.99</span>
						</a>
					</div>
					<div class="wide3">
						...
						<a href="#" class="product">
							<img alt="Featured Product Image" src="products/1.jpg" />
							<span>&pound;29.99</span>
						</a>
					</div>
				</div>
		...
		<div id="mainOuter">
			<div id="mainInner">
				<div class="left">
					...
					<ul>
						<li><a href="#">Bespoke Websites</a></li>
						<li><a href="#">E-Commerce Solutions</a></li>
						<li><a href="#">Database Development</a></li>
						<li><a href="#">Content Management</a></li>
						<li><a href="#">Accessiblity Analysis</a></li>
            ...
            <li><a href="http://virtualfunction.net/services/design/?page=1">Web Design</a></li>
					...
					<ul class="dotted">
						<li><a href="#">2 x USB 128Mb Disk</a></li>
						<li><a href="#">1 x Asus KT7200D Motherboard</a></li>
						<li><a href="#">1 x Radeon 9800</a></li>
						<li><a href="#">2 x IBM SATA 160Gb</a></li>
						<li><a href="#">7200Rpm Harddisk</a></li>
					</ul>
					<div>
						<div class="button1"><a href="#">Edit Basket</a></div>
						<div class="button2"><a href="#">Checkout</a></div>
					</div>
					<div class="titleSide">
						Language
					</div>
				...
				<div class="content">
					...
					personal use, please <a href="#">
					contact me</a> first. Feel free to visit my <a href="#" title="Virtual Function Web Development">
		...
		<div id="footer" class="gap">
			Design &copy; 2005, <a href="#" title="Virtual Function: specialists in Web Design, Ruby on Rails programming, Database development, and bespoke solutions">Virtual Function Web Development</a>
		</div>
	</div>
</div>
</body>
